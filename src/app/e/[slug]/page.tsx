...
import { RSVPButton, GuestAvatars } from '@/components/events';
          ...
          <div className="p-6 sm:p-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-6">
              ...
              <div className="flex items-center gap-3">
                <RSVPButtonWrapper eventId={event.id} currentStatus={event.userRsvp?.status} />
              </div>
            </div>
...
// Client wrapper for RSVPButton
function RSVPButtonWrapper({ eventId, currentStatus }: { eventId: string; currentStatus?: string }) {
  'use client';
  return <RSVPButton eventId={eventId} currentStatus={currentStatus as 'GOING' | 'MAYBE' | 'NOT_GOING' | 'WAITLIST' | undefined} />;
}
